      ...
      <Card>
        ...
        <ul>
          <li>
            ...
            configuran al terreno.
          </li>
          <li>
            Los mosaicos de terreno se cargan en base a la posición del jugador
            de manera que el terreno es infinito. Además, para optimizar la
            performance, los mosaicos más lejanos a la posición del jugador
            tienen menor nivel de detalle.
          </li>
          <li>
            Usando shaders se pueden diseñar dstintos niveles de colores y
            texturas para las distintas elevaciones.
          </li>
          <li>
            Threading para evitar una sobrecarga de uso de CPU cuando un nuevo
            mosaico se tiene que cargar porque entró en el campo de visión del
            jugador.
          </li>
        </ul>
      </Card>
